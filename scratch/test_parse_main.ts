...
function main() {
  const filePath = path.join(process.cwd(), "scratch", "liotech_main.html");
  ...
  console.log("Checking headers on Main Page:");
  ...
  console.log("\nSearching for 'Promoters' or 'Registrar' or 'Industry' in text on Main Page:");
  $("*").each((i, el) => {
